...
from sklearn.ensemble import VotingClassifier, LogisticRegression

class ShallowNetwork(nn.Module):
    def __inti__(self,n_classes):
...
def main():
    ...
    for opt,ckp_pth in zip(models_opt,models_checkpoints):
        ...
        models.append((opt,get_model(config,pretrained=False)))
    ...
    NN = ShallowNetwork(config.train.n_classes)
